...
class pkg_TT_ContentInstallerScript
{
    ...
    public function postflight($route)
    {
		...
		$filename =  JFile::makeSafe('theme--200360-j4');
		$db1 = JFactory::getDBO();
        ...
        // Pankaj : add new HTML for import content message for Joomla 4 (TT-9663)
		echo '<div id="system-message-container" aria-live="polite">
		<joomla-alert type="success" dismiss="true" class="joomla-alert--show" role="alert">
		<button class="joomla-alert--close" aria-label="Close"><span aria-hidden="true">×</span></button>
		<div class="alert-heading"><span class="message"></span><span class="visually-hidden">Message</span>
		</div><div class="alert-wrapper"><div class="alert-message">To import content, please 
		<a href="index.php#content_import">Click here.</a></div></div></joomla-alert>
		</div>';
