...
$doc->addStyleSheet( $this->baseurl . '/media/system/css/joomla-fontawesome.min.css' );
...
<div class="ttr_stickyslideshowshape1">
<div class="html_content"><p style="margin:5px 0px 30px 0px;line-height:4.38em;"><span style="font-family:'Montserrat','Work Sans';font-weight:700;font-size:3.75em;">Where would You Like to Go?</span></p><p style="margin:5px 0px 30px 0px;line-height:2.54em;"><span style="font-family:'Rubik','Work Sans';font-size:1.375em;">Discover the places around the World.</span></p><p style="line-height:5.03em;"><span><a href="https://templatetoaster.com" target="_self" class="btn btn-md btn-default">Read More</a></span></p></div>
</div>
</div>
</div>
</div>
