...
?><a <?php echo $class; ?> href="<?php echo $item->flink; ?>" onclick="window.open(this.href,'targetWindow','<?php echo $attribs;?>');return false;" <?php if (strpos($class, 'dropdown-toggle') !== false){echo''. $toggle .'="dropdown"';} ?> <?php echo $title; ?>><span class="menuchildicon"></span><?php echo $linktype; ?><?php if ((!$justifychk && $m_pos == 'h_menu')  || $m_pos == 'v_menu') {echo '</a>';}
// else{ echo '</a>';}
		break;
endswitch;
